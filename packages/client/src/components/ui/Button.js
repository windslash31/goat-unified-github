...
export const Button = ({
  ...
  const variants = {
    ...
    secondary:
      "bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 focus:ring-kredivo-primary",
    danger:
