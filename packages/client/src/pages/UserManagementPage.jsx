                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {permissions.includes("user:delete") && (
                            <button
                              ...
                              className="p-2 text-gray-500 hover:text-red-600 rounded-full hover:bg-red-100 dark:hover:bg-red-900/20 disabled:opacity-50 disabled:cursor-not-allowed"
                              title="Delete User"
                            >
      ...
      <Portal>
        ...
        {isDeleteModalOpen && (
          <ConfirmationModal
            ...
            title="Delete User"
            message={`This action will permanently delete the user and revoke their access.`}
            confirmationText={userToDelete?.full_name}
          />
        )}
        {isResetModalOpen && (
          <ConfirmationModal
            ...
            title="Reset Password"
            message={`Are you sure you want to reset the password for "${userToReset?.full_name}"? Their old password will no longer work.`}
          />
        )}
        {newPassword && (
        ...
        {isApiKeyModalOpen && userForApiKey && (
          <ApiKeyManagerModal
            user={userForApiKey}
