        ...
        {isDesktop && selectedRows.size > 0 ? (
          <div className="w-full flex justify-between items-center bg-kredivo-light p-2 rounded-lg">
            ...
            <div className="relative">
              <Button onClick={() => setIsBulkActionMenuOpen((prev) => !prev)}>
                Actions
              </Button>
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <div className="relative flex-grow">
                ...
                <input
                  ...
                  className="w-full sm:w-48 pl-10 pr-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-kredivo-primary focus:outline-none"
                />
              </div>
              <div className="relative">
                <button
